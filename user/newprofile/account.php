                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="text" name="" id="" minlength="3" maxlength="50" pattern="([A-Za-z0-9]+)" required>
                                                </h5>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="myaccount-details-area">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="text" name="" id="" required minlength="15" maxlength="150" pattern="([A-Za-z0-9]+)">
                                                </h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="number" name="" id="" required  pattern="([0-9]){6} [0-9]){8}">
                                                </h5>
                                            </td>
                                        </tr>
                                        <tr>
