            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p class="my-md-4 header-links">
                        <a href="../RenDigitizing/user/authentication/login.php" class="px-2">Hello @username</a>
                        <a href="../RenDigitizing/user/authentication/register.php" class="px-1">Logout</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container2 mx-5">
            <div class="row row1">
                <div class="col-md-3 profile-area-sidebar p-5">
                    <a class="current" href="dashboard.php">Dashboard</a>
                ...
                <div class="col-md-9 profile-area-content p-5">
                    <div class="reach-out-buttons">
                        <table class="table table-striped table-items">
                            <th>
                                <a href="#ongoing-orders" class="btn order-btn-1 d-block py-2">Ongoing</a>
                            </th>
                            <th>
                                <a href="#completed-orders" class="btn order-btn-1 d-block py-2">Completed</a>
                            </th>
                            <th>
                                <a href="#cancelled-orders" class="btn order-btn-1 d-block py-2">Cancelled</a>
                            </th>
                        </table>
                    </div>
                    <div class="ongoing-orders" id="ongoing-orders">
                        <h1 class="profile-text-area">Ongoing Orders</h1>
                        <table class="table table-striped table-items">
                            <thead>
                                <tr>
                                    <th>Image</th>
                            ...
                            <tbody>
                                <tr>
                                    <td> <img class="table-image py-2" src="../../styleassets/images/items/item1.jpg"
                                            alt=""> </td>
                                    <td>Embroidery</td>
                                    <td> 1 </td>
                                    <td> 250 </td>
                    ...
                    <div class="completed-orders" id="completed-orders">
                        <h1 class="profile-text-area">Completed Orders</h1>
                        <table class="table table-striped table-items">
                            <thead>
                                <tr>
                                    <th>Image</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row order-button-group d-block">
                                            <div class="col-md-12">
                                                <button class="btn order-btn-1 d-block py-2">Reciept</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="cancelled-orders" id="cancelled-orders">
                        <h1 class="profile-text-area">Cancelled Orders</h1>
                        <table class="table table-striped table-items">
                            <thead>
                                <tr>
                                    <th>Image</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row order-button-group d-block">
                                            <div class="col-md-12">
                                                <button class="btn order-btn-3 d-block py-2">Cancelled</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
