...
<body>
            ...
            <div class="row">
                <div class="col-md-6 text-left">
                    <span class="slide text-left">
                        <a class="openmenu" id="openMenu" onclick="openSlideMenu()">
                            <i class="fas fa-bars hamburger"></i>
                        </a>
                        <a class="closemenu" id="closeMenu" onclick="closeSlideMenu()">
    ...
    <div class="col-md-3 profile-area-sidebar indexnewnavbar p-5 my-2" id="indexBar">
        ...
        <a class="current" href="palceorder.php">Place on order</a>
                        ...
                        <form method="post" name="emimages" id="form1" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <input class="btn order-btn-2 d-block py-2 my-3 specialButton" id="btnPlaceOrder" type="submit"
