...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p class="my-md-4 header-links"><a href="../RenDigitizing/user/authentication/login.php"
                            class="px-2">Hello @username</a><a href="../RenDigitizing/user/authentication/register.php"
                            class="px-1">Logout</a></p>
                </div>
            </div>
        </div>
    </header>
    <div class="profile-area">
        <div class="container2 mx-5">
            <div class="row row1">
                <div class="col-md-3 profile-area-sidebar p-5"><a href="dashboard.php">Dashboard</a><a
                        href="placeorder.php">Place an Order</a><a href="orders.php">My Orders</a><a class="current"
                        href="account.php">Account Details</a><a href="../../index.php">Home</a>
                </div>
                                ...
                                <form method="post">
                                    <table class="myaccount-details-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['firstname'] ?></h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['lastname'] ?></h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['phone'] ?></h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['email'] ?></h5>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="dropdown myaccount-details-phpcontent">
                                                    ...
                                                    <select name="currency" id="currency" class="btn dropdown-select">
                                                        <option value="Select Payment Currency">Select Payment Currency</option>
                                                        <option value="USD">USD</option>
                                                        <option value="Euro">Euro</option>
                                                        <option value="British Pounds">British Pounds</option>
                                                    </select>
                                                    <?php }else{ ?>
                                                    <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['currency'] ?></h5>
                                                    <?php } ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="text" name="company" id="" minlength="3" maxlength="50" pattern="([A-Za-z0-9]+)" required>
                                                </h5>
                                                <?php }else{ ?>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['company'] ?></h5>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="text" name="address" id="" required minlength="10" maxlength="150">
                                                </h5>
                                                <?php }else{ ?>
                                                <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['address'] ?></h5>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><?php if(empty($getDetailsRows['postalcode'])){ ?>
                                                ...
                                                <h5 class="myaccount-details-phpcontent">
                                                    <input type="number" name="postalcode" id="" required  pattern="([0-9]){6} [0-9]){8}">
                                                </h5>
                                                    <?php }else{ ?>
                                                    <h5 class="myaccount-details-phpcontent">: <?php echo $getDetailsRows['postalcode'] ?></h5>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                                ...
                                                <table>
                                                    <form id="passwordValidation" data-toggle="validator" method="post">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="old-account-password" name="old-account-password" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="password" id="confirm-new-account-password" name="confirm-new-account-password"
