...
if (isset($_POST['submit'])) {
        ...
        if (empty($name)) {
            ...
            $companyErr = "Please provide company name";
                ...
                <div class="col-md-6 text-right my-auto">
                    <p class="my-md-4 header-links">
                        <?php if(isset($_SESSION['USER'])){ ?><a
                            href="user/profile/account.php?nosession=false&ref=contactus&userauth=<?php echo $token ?>"
                            class="px-2"><?php echo $_SESSION['USER']?></a><?php }else { ?><a
                            href="user/authentication/register.php?nosession=true&ref=contactus&userauth=<?php $token ?>"
                            class="px-2">Create an account</a><?php } ?>
                        <?php if(isset($_SESSION['USER'])){ ?><a
                            href="user/authentication/logout.php?securelogout=true&status=success&userauth=<?php $token ?>"
                            class="px-2">Logout</a><?php }else { ?><a
                            href="user/authentication/login.php?nosession=true&ref=contactus&userauth=<?php $token ?>"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link"
                            href="index.php?nosession=<?php echo $nosession ?>&userauth=<?php echo $token ?>">Home <span
                ...
                ?>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link"
                            href="user/profile/account.php?nosession=false&ref=contactus&userauth=<?php echo $token ?>">My
                ...
                ?>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link"
                            href="user/profile/orders.php?nosession=false&ref=contactus&userauth=<?php echo $token ?>">My
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="contact.php?nosession=<?php echo $nosession ?>&userauth=<?php echo $token ?>">Contact
                            Us</a>
                    </li>
                </ul>
            </div>
